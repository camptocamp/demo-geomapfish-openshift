  ...
  node('geomapfish'){
    ...
    openshift.withCluster() {
      openshift.doAs('openshift-token') {
        ...
        stage('test-staging') {
          sh 'curl https://demo-geomapfish-wsgi.geomapfish-stage.svc:8480/check_collector?'
          sh 'curl https://demo-geomapfish-wsgi.geomapfish-stage.svc:8480/check_collector?type=all'
        }
